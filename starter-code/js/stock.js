...
function listStock() {
    ...
    mData.forEach(e => {
        ...
        subcontenedor = contenedor.getElementsByClassName('linea');
        // _id
    ...
    contenedor = document.getElementsByClassName('container');
    contenedor[0].innerHTML = "";
    creaBotonDemand(document.getElementsByClassName('container')); 
    creaBotonAddProduct(document.getElementsByClassName('container'),"id-btn-addprod1"); 
    creaBotonDeleteProduct(document.getElementsByClassName('container')); 
    creaBotonOrderProduct(document.getElementsByClassName('container'));
}
...
function creaCabecera() { 
    ...
    contenedor.appendChild(element);
    let subcontenedor = contenedor.getElementsByClassName('cabecera');
    // _id
    ...
    // QTY DEMAND
    elementoListStock(subcontenedor[0],"QTY DEMAND");
    // demand
...
function creaBotonOrderProduct(contenedor) {
    let element = document.createElement('div');
    element.setAttribute('class','btn btn-order');
    element.innerText = 'Order';
    contenedor[0].appendChild(element);
    // Genero un evento para el boton AddProd
    element.addEventListener('click', orderProduct);
}
...
function orderProduct() {
    mData.sort((a,b)=>a.quantity-b.quantity);
    if(mPedidos.length !== 0)
        mPedidos.sort((a,b)=>a.quantity-b.quantity);
    listStock();
}
